...
public class generalizationLine extends basicLine{
	...
	public void draw(Graphics g) {
        ...
        double extendPoint1Y = y2+normalDistanceX-normalDistanceY;
        double extendPoint2X = x2+normalDistanceY-normalDistanceX;
        double extendPoint2Y = y2-normalDistanceY-normalDistanceX;
        g.drawLine(x2, y2, (int) extendPoint1X, (int) extendPoint1Y);
        g.drawLine((int) extendPoint1X, (int) extendPoint1Y, (int) extendPoint2X, (int) extendPoint2Y);
        g.drawLine((int) extendPoint2X, (int) extendPoint2Y, x2, y2);
		g.drawLine(x1, y1, (int) (x2-normalDistanceX), (int) (y2-normalDistanceY));
	}
}
